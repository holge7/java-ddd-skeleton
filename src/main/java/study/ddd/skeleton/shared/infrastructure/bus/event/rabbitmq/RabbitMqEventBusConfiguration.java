...
import study.ddd.skeleton.shared.infrastructure.bus.event.DomainEventsInformation;
...
public class RabbitMqEventBusConfiguration {
    ...
    // Configuración de intercambios y colas necesarios para el EventBus
    @Bean
    ...
    // Método para declarar colas y bindings
    ...
    // Configuración de argumentos para la cola de reintentos
