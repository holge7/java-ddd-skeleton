...
public final class HibernateConfigurationFactory {
    ...
    private List<Resource> searchMappingFiles(String contextName) {
        ...
        System.out.println("XML hbm encontrados: ");
    ...
    private List<String> subdirectoriesFor(String contextName) {
        String path = "./src/main/java/study/ddd/skeleton/" + contextName + "/";

        String[] files = new File(path).list((current, name) -> new File(current, name).isDirectory());

        if (null == files) {
            path  = "./main/java/study/ddd/skeleton/" + contextName + "/";
    ...
    private String[] mappingFilesIn(String path) {
        ...
        if (hbmFiles != null) {
            System.out.println(Arrays.toString(hbmFiles));
